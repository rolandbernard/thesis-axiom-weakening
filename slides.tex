...
\begin{frame}
  ...
  \begin{items}
    \begin{oitem}{\icon{wrench}}
      An ontology is repaired once using axiom weakening and once using removal  \\
      \sitem {\footnotesize compare the quality of the resulting ontologies}
    \end{oitem}
...
\begin{frame}
  ...
  \begin{items}
    ...
    \begin{oitem}{\icon{lightbulb}}
      Study other possible applications using more expressive description logics
    \end{oitem}
  \end{items}
\end{frame}
